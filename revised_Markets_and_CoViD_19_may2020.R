...
data_merge <- read.csv("outputs/Indesign/data_merge.csv",stringsAsFactors=FALSE, na.strings = c(""," ","NA"))
...
df$day[df$day == "1"| df$day == "2" |df$day == "3" | df$day == "4" | df$day == "5"| df$day == "6"| df$day == "7" |df$day == "8"| df$day == "9" |df$day == "10" | df$day == "11" | df$day == "12"| df$day == "13" ]<- "Bi 1"
df$day[ df$day == "14" | df$day == "15" | df$day == "16" | df$day == "17" | df$day == "18" | df$day == "19"| df$day == "20"| df$day == "21" |df$day == "22"| df$day == "23" |df$day == "24" | df$day == "25" | df$day == "26"| df$day == "27"| df$day == "28" | df$day == "29"| df$day == "30"| df$day == "31"] <- "Bi 2"
...
Market_info <- df1 %>%  select(Regions,DISTRICT,settlement,period,agents_open,trader_restricted,starts_with(c("payment_type","vendors","customer","safety","item_name_scarce.","item_scarcity_reason","stock_runout","Order_in_week_item","cross_border_trade","goods_restricted")),new_rules,reason_restricted,challenge,
...
list_of_datasets <- list("National level median" = national_items,"Market median price" = markets_items, "Settlement median price" = settlment_items,
                         "Region median" = region_items, "Disrict Median" = district_items,
